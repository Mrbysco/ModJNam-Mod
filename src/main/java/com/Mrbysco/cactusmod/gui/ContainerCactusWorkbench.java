...
public class ContainerCactusWorkbench extends ContainerWorkbench {
    private final World world;
    /** Position of the workbench */
    private final BlockPos pos;

    public ContainerCactusWorkbench(InventoryPlayer playerInventory, World worldIn, BlockPos posIn)
    {
