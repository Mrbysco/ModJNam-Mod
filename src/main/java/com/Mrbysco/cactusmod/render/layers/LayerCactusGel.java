...
public class LayerCactusGel implements LayerRenderer<EntitySlime>
{
    private final RenderCactusSlime slimeRenderer;
    private final ModelBase slimeModel = new ModelSlime(0);

    public LayerCactusGel(RenderCactusSlime slimeRendererIn)
    {
