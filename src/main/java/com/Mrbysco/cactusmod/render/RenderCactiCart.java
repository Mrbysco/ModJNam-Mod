...
public class RenderCactiCart extends Render<EntityCactiCart>{
	...
	protected RenderCactiCart(RenderManager renderManager) {
		super(renderManager);
        this.shadowSize = 0.5F;
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityCactiCart entity) {
		return CACTICART;
	}
	
	@Override
	public void doRender(EntityCactiCart entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	public static class Factory implements IRenderFactory<EntityCactiCart> {
		@Override
		public Render<? super EntityCactiCart> createRenderFor(RenderManager manager) {
			return new RenderCactiCart(manager);
		}
	}
