...
public class CactusChestTESR <T extends TileEntity & IChestLid> extends TileEntityRenderer<T> {
	...
	public void render(T tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
		...
		BlockState blockstate = flag ? tileEntityIn.getBlockState() : CactusRegistry.CACTUS_CHEST.get().getDefaultState().with(CactusChestBlock.FACING, Direction.SOUTH);
		...
		if (block instanceof CactusChestBlock) {
			...
			RenderMaterial rendermaterial = new RenderMaterial(Atlases.CHEST_ATLAS, ClientHandler.CACTUS_CHEST_LOCATION);
